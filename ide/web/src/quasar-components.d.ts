...
declare module "vue" {
  ...
  type NoFunctions<T> = Omit<T, NoFunctionKeys<T>>;

  export interface QAjaxBar {
    /**
  ...
  export interface GlobalComponents {
    QAjaxBar: new () => ComponentPublicInstance<NoFunctions<QAjaxBar>>;
    QAvatar: new () => ComponentPublicInstance<NoFunctions<QAvatar>>;
    QBadge: new () => ComponentPublicInstance<NoFunctions<QBadge>>;
    QBanner: new () => ComponentPublicInstance<NoFunctions<QBanner>>;
    QBar: new () => ComponentPublicInstance<NoFunctions<QBar>>;
    QBreadcrumbs: new () => ComponentPublicInstance<NoFunctions<QBreadcrumbs>>;
    QBreadcrumbsEl: new () => ComponentPublicInstance<NoFunctions<QBreadcrumbsEl>>;
    QBtnDropdown: new () => ComponentPublicInstance<NoFunctions<QBtnDropdown>>;
    QBtnGroup: new () => ComponentPublicInstance<NoFunctions<QBtnGroup>>;
    QBtnToggle: new () => ComponentPublicInstance<NoFunctions<QBtnToggle>>;
    QBtn: new () => ComponentPublicInstance<NoFunctions<QBtn>>;
    QCard: new () => ComponentPublicInstance<NoFunctions<QCard>>;
    QCardActions: new () => ComponentPublicInstance<NoFunctions<QCardActions>>;
    QCardSection: new () => ComponentPublicInstance<NoFunctions<QCardSection>>;
    QCarousel: new () => ComponentPublicInstance<NoFunctions<QCarousel>>;
    QCarouselControl: new () => ComponentPublicInstance<NoFunctions<QCarouselControl>>;
    QCarouselSlide: new () => ComponentPublicInstance<NoFunctions<QCarouselSlide>>;
    QChatMessage: new () => ComponentPublicInstance<NoFunctions<QChatMessage>>;
    QCheckbox: new () => ComponentPublicInstance<NoFunctions<QCheckbox>>;
    QChip: new () => ComponentPublicInstance<NoFunctions<QChip>>;
    QCircularProgress: new () => ComponentPublicInstance<NoFunctions<QCircularProgress>>;
    QColor: new () => ComponentPublicInstance<NoFunctions<QColor>>;
    QDate: new () => ComponentPublicInstance<NoFunctions<QDate>>;
    QDialog: new () => ComponentPublicInstance<NoFunctions<QDialog>>;
    QDrawer: new () => ComponentPublicInstance<NoFunctions<QDrawer>>;
    QEditor: new () => ComponentPublicInstance<NoFunctions<QEditor>>;
    QExpansionItem: new () => ComponentPublicInstance<NoFunctions<QExpansionItem>>;
    QFab: new () => ComponentPublicInstance<NoFunctions<QFab>>;
    QFabAction: new () => ComponentPublicInstance<NoFunctions<QFabAction>>;
    QField: new () => ComponentPublicInstance<NoFunctions<QField>>;
    QFile: new () => ComponentPublicInstance<NoFunctions<QFile>>;
    QFooter: new () => ComponentPublicInstance<NoFunctions<QFooter>>;
    QForm: new () => ComponentPublicInstance<NoFunctions<QForm>>;
    QFormChildMixin: new () => ComponentPublicInstance<NoFunctions<QFormChildMixin>>;
    QHeader: new () => ComponentPublicInstance<NoFunctions<QHeader>>;
    QIcon: new () => ComponentPublicInstance<NoFunctions<QIcon>>;
    QImg: new () => ComponentPublicInstance<NoFunctions<QImg>>;
    QInfiniteScroll: new () => ComponentPublicInstance<NoFunctions<QInfiniteScroll>>;
    QInnerLoading: new () => ComponentPublicInstance<NoFunctions<QInnerLoading>>;
    QInput: new () => ComponentPublicInstance<NoFunctions<QInput>>;
    QIntersection: new () => ComponentPublicInstance<NoFunctions<QIntersection>>;
    QItem: new () => ComponentPublicInstance<NoFunctions<QItem>>;
    QItemLabel: new () => ComponentPublicInstance<NoFunctions<QItemLabel>>;
    QItemSection: new () => ComponentPublicInstance<NoFunctions<QItemSection>>;
    QList: new () => ComponentPublicInstance<NoFunctions<QList>>;
    QKnob: new () => ComponentPublicInstance<NoFunctions<QKnob>>;
    QLayout: new () => ComponentPublicInstance<NoFunctions<QLayout>>;
    QLinearProgress: new () => ComponentPublicInstance<NoFunctions<QLinearProgress>>;
    QMarkupTable: new () => ComponentPublicInstance<NoFunctions<QMarkupTable>>;
    QMenu: new () => ComponentPublicInstance<NoFunctions<QMenu>>;
    QNoSsr: new () => ComponentPublicInstance<NoFunctions<QNoSsr>>;
    QOptionGroup: new () => ComponentPublicInstance<NoFunctions<QOptionGroup>>;
    QPageScroller: new () => ComponentPublicInstance<NoFunctions<QPageScroller>>;
    QPageSticky: new () => ComponentPublicInstance<NoFunctions<QPageSticky>>;
    QPage: new () => ComponentPublicInstance<NoFunctions<QPage>>;
    QPageContainer: new () => ComponentPublicInstance<NoFunctions<QPageContainer>>;
    QPagination: new () => ComponentPublicInstance<NoFunctions<QPagination>>;
    QParallax: new () => ComponentPublicInstance<NoFunctions<QParallax>>;
    QPopupEdit: new () => ComponentPublicInstance<NoFunctions<QPopupEdit>>;
    QPopupProxy: new () => ComponentPublicInstance<NoFunctions<QPopupProxy>>;
    QPullToRefresh: new () => ComponentPublicInstance<NoFunctions<QPullToRefresh>>;
    QRadio: new () => ComponentPublicInstance<NoFunctions<QRadio>>;
    QRange: new () => ComponentPublicInstance<NoFunctions<QRange>>;
    QRating: new () => ComponentPublicInstance<NoFunctions<QRating>>;
    QResizeObserver: new () => ComponentPublicInstance<NoFunctions<QResizeObserver>>;
    QResponsive: new () => ComponentPublicInstance<NoFunctions<QResponsive>>;
    QScrollArea: new () => ComponentPublicInstance<NoFunctions<QScrollArea>>;
    QScrollObserver: new () => ComponentPublicInstance<NoFunctions<QScrollObserver>>;
    QSelect: new () => ComponentPublicInstance<NoFunctions<QSelect>>;
    QSeparator: new () => ComponentPublicInstance<NoFunctions<QSeparator>>;
    QSkeleton: new () => ComponentPublicInstance<NoFunctions<QSkeleton>>;
    QSlideItem: new () => ComponentPublicInstance<NoFunctions<QSlideItem>>;
    QSlideTransition: new () => ComponentPublicInstance<NoFunctions<QSlideTransition>>;
    QSlider: new () => ComponentPublicInstance<NoFunctions<QSlider>>;
    QSpace: new () => ComponentPublicInstance<NoFunctions<QSpace>>;
    QSpinner: new () => ComponentPublicInstance<NoFunctions<QSpinner>>;
    QSpinnerAudio: new () => ComponentPublicInstance<NoFunctions<QSpinnerAudio>>;
    QSpinnerBall: new () => ComponentPublicInstance<NoFunctions<QSpinnerBall>>;
    QSpinnerBars: new () => ComponentPublicInstance<NoFunctions<QSpinnerBars>>;
    QSpinnerBox: new () => ComponentPublicInstance<NoFunctions<QSpinnerBox>>;
    QSpinnerClock: new () => ComponentPublicInstance<NoFunctions<QSpinnerClock>>;
    QSpinnerComment: new () => ComponentPublicInstance<NoFunctions<QSpinnerComment>>;
    QSpinnerCube: new () => ComponentPublicInstance<NoFunctions<QSpinnerCube>>;
    QSpinnerDots: new () => ComponentPublicInstance<NoFunctions<QSpinnerDots>>;
    QSpinnerFacebook: new () => ComponentPublicInstance<NoFunctions<QSpinnerFacebook>>;
    QSpinnerGears: new () => ComponentPublicInstance<NoFunctions<QSpinnerGears>>;
    QSpinnerGrid: new () => ComponentPublicInstance<NoFunctions<QSpinnerGrid>>;
    QSpinnerHearts: new () => ComponentPublicInstance<NoFunctions<QSpinnerHearts>>;
    QSpinnerHourglass: new () => ComponentPublicInstance<NoFunctions<QSpinnerHourglass>>;
    QSpinnerInfinity: new () => ComponentPublicInstance<NoFunctions<QSpinnerInfinity>>;
    QSpinnerIos: new () => ComponentPublicInstance<NoFunctions<QSpinnerIos>>;
    QSpinnerOrbit: new () => ComponentPublicInstance<NoFunctions<QSpinnerOrbit>>;
    QSpinnerOval: new () => ComponentPublicInstance<NoFunctions<QSpinnerOval>>;
    QSpinnerPie: new () => ComponentPublicInstance<NoFunctions<QSpinnerPie>>;
    QSpinnerPuff: new () => ComponentPublicInstance<NoFunctions<QSpinnerPuff>>;
    QSpinnerRadio: new () => ComponentPublicInstance<NoFunctions<QSpinnerRadio>>;
    QSpinnerRings: new () => ComponentPublicInstance<NoFunctions<QSpinnerRings>>;
    QSpinnerTail: new () => ComponentPublicInstance<NoFunctions<QSpinnerTail>>;
    QSplitter: new () => ComponentPublicInstance<NoFunctions<QSplitter>>;
    QStep: new () => ComponentPublicInstance<NoFunctions<QStep>>;
    QStepper: new () => ComponentPublicInstance<NoFunctions<QStepper>>;
    QStepperNavigation: new () => ComponentPublicInstance<NoFunctions<QStepperNavigation>>;
    QTabPanel: new () => ComponentPublicInstance<NoFunctions<QTabPanel>>;
    QTabPanels: new () => ComponentPublicInstance<NoFunctions<QTabPanels>>;
    QTable: new () => ComponentPublicInstance<NoFunctions<QTable>>;
    QTd: new () => ComponentPublicInstance<NoFunctions<QTd>>;
    QTh: new () => ComponentPublicInstance<NoFunctions<QTh>>;
    QTr: new () => ComponentPublicInstance<NoFunctions<QTr>>;
    QRouteTab: new () => ComponentPublicInstance<NoFunctions<QRouteTab>>;
    QTab: new () => ComponentPublicInstance<NoFunctions<QTab>>;
    QTabs: new () => ComponentPublicInstance<NoFunctions<QTabs>>;
    QTime: new () => ComponentPublicInstance<NoFunctions<QTime>>;
    QTimeline: new () => ComponentPublicInstance<NoFunctions<QTimeline>>;
    QTimelineEntry: new () => ComponentPublicInstance<NoFunctions<QTimelineEntry>>;
    QToggle: new () => ComponentPublicInstance<NoFunctions<QToggle>>;
    QToolbar: new () => ComponentPublicInstance<NoFunctions<QToolbar>>;
    QToolbarTitle: new () => ComponentPublicInstance<NoFunctions<QToolbarTitle>>;
    QTooltip: new () => ComponentPublicInstance<NoFunctions<QTooltip>>;
    QTree: new () => ComponentPublicInstance<NoFunctions<QTree>>;
    QUploader: new () => ComponentPublicInstance<NoFunctions<QUploader>>;
    QUploaderAddTrigger: new () => ComponentPublicInstance<NoFunctions<QUploaderAddTrigger>>;
    QVideo: new () => ComponentPublicInstance<NoFunctions<QVideo>>;
    QVirtualScroll: new () => ComponentPublicInstance<NoFunctions<QVirtualScroll>>;
  }
}
